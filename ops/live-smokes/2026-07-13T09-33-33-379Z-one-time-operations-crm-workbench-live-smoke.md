# One Time Operations CRM Workbench Live Smoke - 2026-07-13T09:33:33.379Z
...
## Checks
- PASS operations login uses One Time Railway auth fallback (2010ms)
- PASS deployed Operations HTML includes CRM workbench detail markers (1410ms)
- PASS scoped CRM contacts API responds without external-write flags (269ms)
- PASS selected CRM timeline API is read-only when a card exists (255ms)
