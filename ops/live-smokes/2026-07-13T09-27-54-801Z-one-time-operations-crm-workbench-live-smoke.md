# One Time Operations CRM Workbench Live Smoke - 2026-07-13T09:27:54.801Z
...
## Checks
- PASS operations login uses One Time Railway auth fallback (2095ms)
- PASS deployed Operations HTML includes CRM workbench detail markers (1096ms)
- PASS scoped CRM contacts API responds without external-write flags (272ms)
- PASS selected CRM timeline API is read-only when a card exists (252ms)
