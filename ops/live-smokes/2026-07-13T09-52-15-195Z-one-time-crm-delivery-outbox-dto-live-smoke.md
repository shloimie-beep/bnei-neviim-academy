# One Time CRM Delivery Outbox DTO Live Smoke - 2026-07-13T09:52:15.195Z
...
## Checks
- PASS operations login uses One Time Railway auth fallback (1980ms)
- PASS scoped One Time CRM list exposes canonical contacts without external writes (507ms)
- PASS selected contact Activity exposes delivery outbox rows only when live outbox data exists (3602ms)
