# One Time Operations CRM Workbench Live Smoke - 2026-07-12T23:00:18.923Z
...
## Checks
- PASS operations login uses One Time Railway auth fallback (1918ms)
- PASS deployed Operations HTML includes CRM workbench detail markers (1137ms)
- PASS scoped CRM contacts API responds without external-write flags (281ms)
- PASS selected CRM timeline API is read-only when a card exists (251ms)
