# One Time Operations CRM Workbench Live Smoke - 2026-07-13T07:45:19.025Z
...
## Checks
- PASS operations login uses One Time Railway auth fallback (4132ms)
- PASS deployed Operations HTML includes CRM workbench detail markers (1144ms)
- PASS scoped CRM contacts API responds without external-write flags (268ms)
- PASS selected CRM timeline API is read-only when a card exists (266ms)
