# One Time Operations CRM Workbench Live Smoke - 2026-07-12T22:41:20.271Z
...
## Checks
- PASS operations login uses One Time Railway auth fallback (4048ms)
- PASS deployed Operations HTML includes CRM workbench detail markers (1086ms)
- PASS scoped CRM contacts API responds without external-write flags (248ms)
- PASS selected CRM timeline API is read-only when a card exists (237ms)
