# One Time Operations CRM Workbench Live Smoke - 2026-07-13T09:51:50.245Z
...
## Checks
- PASS operations login uses One Time Railway auth fallback (2014ms)
- PASS deployed Operations HTML includes CRM workbench detail markers (1125ms)
- PASS scoped CRM contacts API responds without external-write flags (277ms)
- PASS selected CRM timeline API is read-only when a card exists (260ms)
