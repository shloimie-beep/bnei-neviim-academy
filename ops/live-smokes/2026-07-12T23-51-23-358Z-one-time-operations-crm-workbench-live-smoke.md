# One Time Operations CRM Workbench Live Smoke - 2026-07-12T23:51:23.358Z
...
## Checks
- PASS operations login uses One Time Railway auth fallback (2047ms)
- PASS deployed Operations HTML includes CRM workbench detail markers (1217ms)
- PASS scoped CRM contacts API responds without external-write flags (256ms)
- PASS selected CRM timeline API is read-only when a card exists (235ms)
