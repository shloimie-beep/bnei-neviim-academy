# One Time Operations CRM Workbench Live Smoke - 2026-07-13T12:45:49.360Z
...
## Checks
- PASS operations login uses One Time Railway auth fallback (2145ms)
- PASS deployed Operations HTML includes CRM workbench detail markers (1094ms)
- PASS scoped CRM contacts API responds without external-write flags (287ms)
- PASS selected CRM timeline API is read-only when a card exists (247ms)
