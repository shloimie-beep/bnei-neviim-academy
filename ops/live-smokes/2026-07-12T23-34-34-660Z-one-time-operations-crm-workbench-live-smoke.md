# One Time Operations CRM Workbench Live Smoke - 2026-07-12T23:34:34.660Z
...
## Checks
- PASS operations login uses One Time Railway auth fallback (1995ms)
- PASS deployed Operations HTML includes CRM workbench detail markers (1172ms)
- PASS scoped CRM contacts API responds without external-write flags (247ms)
- PASS selected CRM timeline API is read-only when a card exists (230ms)
