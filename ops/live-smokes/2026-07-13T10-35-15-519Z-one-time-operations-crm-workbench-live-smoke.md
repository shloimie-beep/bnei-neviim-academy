# One Time Operations CRM Workbench Live Smoke - 2026-07-13T10:35:15.519Z
...
## Checks
- PASS operations login uses One Time Railway auth fallback (4401ms)
- PASS deployed Operations HTML includes CRM workbench detail markers (1139ms)
- PASS scoped CRM contacts API responds without external-write flags (292ms)
- PASS selected CRM timeline API is read-only when a card exists (261ms)
