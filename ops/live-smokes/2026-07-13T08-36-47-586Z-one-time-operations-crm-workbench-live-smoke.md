# One Time Operations CRM Workbench Live Smoke - 2026-07-13T08:36:47.586Z
...
## Checks
- PASS operations login uses One Time Railway auth fallback (3956ms)
- PASS deployed Operations HTML includes CRM workbench detail markers (1081ms)
- PASS scoped CRM contacts API responds without external-write flags (256ms)
- PASS selected CRM timeline API is read-only when a card exists (259ms)
