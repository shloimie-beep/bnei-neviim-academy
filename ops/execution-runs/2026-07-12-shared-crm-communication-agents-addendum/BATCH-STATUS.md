...
| 2-shared-crm | REQ-20260712-302 | In progress | Shared CRM service/module slice pushed and deployed through hotfix SHA `bf0ec619b`; URL-state slice deployed through `f818822bb`; local update/no-auto-task slice locally verified; BNA/One Time deploy-info match; One Time route smoke passed; Operations CRM workbench live smoke passed with 12 scoped cards and read-only timeline | Deploy and live-smoke local update/no-auto-task slice, then continue dedicated contact workspace/actions and deeper parity batches. |
