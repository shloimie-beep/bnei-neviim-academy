...
Latest deployed SHA: `3293d3528ace28938d5f13d8b65b485448c9ebc9`

Current proof:

- `3293d3528ace28938d5f13d8b65b485448c9ebc9` is pushed to `origin/master`.
...
- Shared CRM contract/geometry is locally verified and pending deploy under `REQ-20260712-302`: the shared module owns `shared-crm-v1`, Operations emits shared component order/pane/breakpoint/back-control data attributes, and local smoke asserts the 40px Back to contacts target across mobile viewports.
...
- deploy/live-smoke shared CRM contract/geometry, then continue remaining dedicated CRM workspace/actions and component parity under `REQ-20260712-302` / `REQ-20260712-303`, especially complete/reopen task and family/member linking;
