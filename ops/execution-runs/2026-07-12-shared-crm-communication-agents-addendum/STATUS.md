...
- Shared CRM contract/geometry slice is locally verified and pending deploy for `REQ-20260712-302`: `public/js/crm/contact-workspace.js` owns the `shared-crm-v1` workbench contract, Operations emits the same component order, pane count, mobile/tablet breakpoint, and 40px back-control target as data attributes, and local smoke asserts the contract across split shell and monolith at 1440/1024/768/430/390.
