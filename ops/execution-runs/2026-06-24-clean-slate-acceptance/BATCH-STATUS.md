...
|---|---|---|---|---|
| A | REQ-20260624-032 | Done | `EVIDENCE.md` | Continue run/queue truth |
| B | REQ-20260624-033 | Done | `latest.json`, `run.json` | Continue PR closeout |
| C | REQ-20260624-034 | Done | census/queue/cleanup reports | Keep broader cleanup owner-gated |
| D | REQ-20260624-035 | Done | `TEST-RESULTS.md` | Rerun run CLI after final status update |
