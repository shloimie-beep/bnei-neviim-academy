...
| BATCH-11-VERIFY-DEPLOY | REQ-20260712-112 | Blocked | Release-gate dry-run blocked on mixed dirty worktree, unpushed/non-release HEAD, and Railway/Drive external readback readiness gaps. |
