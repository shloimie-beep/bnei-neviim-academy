...
|---|---|---|---|
| A | REQ-20260624-028 | done | Use census for queue/control files. |
| B | REQ-20260624-029 | done | Preservation branch merged into integration base. |
| C | REQ-20260624-030 | done | Use PR reconciliation in control manifest. |
