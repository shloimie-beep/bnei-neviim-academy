...
| 15 | REQ-20260619-310 | done | Gamification deployed and live-smoked in Railway deployment `dcc60355-48fa-4a16-8cd2-5d05c3e8622c`: event-driven automatic badges use per-badge rules, Rabbi-awarded badges remain review-gated, manual reversal requires a reason and audit event, readiness is no-write, and no public individual leaderboard, prizes/credits, access grants, sends, charges, or external writes are enabled. |
