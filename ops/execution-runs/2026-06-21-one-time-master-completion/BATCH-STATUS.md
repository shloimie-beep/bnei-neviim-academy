...
| 9D | REQ-20260621-904 | done | Scoped first-party CRM import/dedupe preview deployed and live-smoked with metadata-only inventory refs, no raw source rows, no-send warm leads, and no local/external/GHL writes. |
