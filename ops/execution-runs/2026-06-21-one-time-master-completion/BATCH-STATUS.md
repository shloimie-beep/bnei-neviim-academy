...
| 9F | REQ-20260621-906 | in_progress | Warm-lead 30-day trial, $67 renewal, card-required/one-intro-trial rules, referral-after-first-paid-cycle model, policy-version acceptance storage, legal wording Decision, Operations panel, Stripe local-beta no-write guardrails, focused tests, and smoke script are implemented locally. Deployment and live smoke are pending after commit/push. |
