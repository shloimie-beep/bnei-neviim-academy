...
| 9I | REQ-20260621-909 | in_progress | Test identities and mock data implementation started: build safe TEST-prefixed beta identities, mock scenarios, cleanup/readback checks, and negative authorization matrix without real private exports. |
