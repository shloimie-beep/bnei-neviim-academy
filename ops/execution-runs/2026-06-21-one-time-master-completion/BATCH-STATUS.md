...
| 9G | REQ-20260621-907 | done | Payment-to-access and class-link readiness deployed and live-smoked: test/manual payment state remains no-write, access grants require approved local/test event plus manual review, member class links are relationship scoped, and raw Zoom join plus host/start URLs stay blocked. Railway deployment `a0b6dcb5-a593-41f9-9743-bcc717d41730`, standard smoke, and focused 9G smoke passed. |
