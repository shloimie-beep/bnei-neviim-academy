...
| 9H | REQ-20260621-908 | in_progress | Authenticated question/support-ticket hardening started: preserve disabled study-bot guardrail while adding scoped ticket numbers, authenticated context, requester-visible staff replies, and private internal-note filtering. |
