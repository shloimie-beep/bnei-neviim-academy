...
| delta-B4 | REQ-20260712-804 | not_started | Requires committed/pushed runner plus Railway/automation readback. |
| delta-A | REQ-20260712-802 | not_started | Existing implementation must be audited before edits. |
| delta-C0 | REQ-20260712-805 | not_started | Blueprint and gap matrix before UI code. |
| delta-C1-C9 | REQ-20260712-806 | not_started | Implement only missing/partial rows. |
