...
Current verification batch: REQ-20260618-126 now has browser-level local proof for scoped ordinary-user behavior. It remains needs_verification only because release approval, deployment, and live smoke are pending. Next unblocked local verification target is REQ-20260618-127.
