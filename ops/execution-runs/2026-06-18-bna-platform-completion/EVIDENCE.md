...
| REQ-20260618-104 | in_progress | current batch commit: feat: add operations workspace selector scoping | node --test tests/operations-workspace-selector.test.js PASS 4/4<br>npm test PASS 81/81 | Operations shell now includes an identity-aware workspace context control for super-admin selection versus ordinary scoped-user locked context. | Release approval/deploy pending; not closed. |
