...
| E | REQ-20260623-209 | blocked | External readback/backfill gate implemented and backfill apply now requires readback confirmation plus numeric job range; await configured DB/Railway/Drive targets and explicit approvals |
