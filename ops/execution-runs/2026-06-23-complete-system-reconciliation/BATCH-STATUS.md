...
| F | REQ-20260623-210 | in progress | Stable display ID, prompt lifecycle, source adapter, intake service, local persistence readback, watchdog contract, local synthetic E2E, parsed entity projection, auto-resume lifecycle, and auto-resume watchdog slices verified; continue approved persistence/UI closeout |
