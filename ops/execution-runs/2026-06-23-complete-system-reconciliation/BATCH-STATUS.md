...
| F | REQ-20260623-210 | in progress | Stable display ID, prompt lifecycle, source adapter, intake service, local persistence readback, watchdog contract, local synthetic E2E, and parsed entity projection slices verified; continue approved persistence/UI/watchdog closeout |
