...
Generated: 2026-06-24T17:34:13.314Z
...
| 192dc5034b5b8f8a | tasks | unknown | bna | 4 | 1502, 1501, 1504, 1503 | b5cbfac5ac12d794 | archive_or_link_duplicates_after_operator_review |
| 279e9bc14049f856 | tasks | unknown | bna | 6 | 1479, 1478, 1477, 1480, 1481, 1482 | 8dbdb13eafc92a2e | archive_or_link_duplicates_after_operator_review |
...
| 0c1812c8ee846b21 | tasks | unknown | bna | 2 | 1460, 1461 | 6528b9548aaef316 | archive_or_link_duplicates_after_operator_review |
...
| 54c33e529738b0d1 | tasks | unknown | bna | 15 | 1152, 1164, 1155, 1160, 1154, 1163, 1149, 1151, 1156, 1161, 1153, 1157, 1159, 1162, 1158 | 13db71217143751a | archive_or_link_duplicates_after_operator_review |
| 629d0f50054615bf | tasks | unknown | bna | 4 | 1026, 1029, 1027, 1028 | dc58447febd3bb2a | archive_or_link_duplicates_after_operator_review |
...
| unscoped_record | high | 1610 | tasks | unknown | Attach the task to exactly one workspace/project or quarantine it from default views. |
| orphaned_record | medium | 1610 | tasks | unknown | Attach a project, archive as provenance, or link to the canonical requirement. |
| unscoped_record | high | 1609 | tasks | unknown | Attach the task to exactly one workspace/project or quarantine it from default views. |
| orphaned_record | medium | 1609 | tasks | unknown | Attach a project, archive as provenance, or link to the canonical requirement. |
...
| repeated_parser_fan_out | high | 1502 | tasks | unknown | Collapse repeated parser fan-out into one canonical executable requirement and archive duplicates. |
| repeated_parser_fan_out | high | 1479 | tasks | unknown | Collapse repeated parser fan-out into one canonical executable requirement and archive duplicates. |
...
| repeated_parser_fan_out | high | 1152 | tasks | unknown | Collapse repeated parser fan-out into one canonical executable requirement and archive duplicates. |
| repeated_parser_fan_out | high | 1026 | tasks | unknown | Collapse repeated parser fan-out into one canonical executable requirement and archive duplicates. |
...
| archive_or_link_duplicates_after_operator_review | yes | 1502, 1501, 1504, 1503 | Duplicate-like tasks group 192dc5034b5b8f8a | operator approval required |
| archive_or_link_duplicates_after_operator_review | yes | 1479, 1478, 1477, 1480, 1481, 1482 | Duplicate-like tasks group 279e9bc14049f856 | operator approval required |
...
| archive_or_link_duplicates_after_operator_review | yes | 1460, 1461 | Duplicate-like tasks group 0c1812c8ee846b21 | operator approval required |
...
| archive_or_link_duplicates_after_operator_review | yes | 1152, 1164, 1155, 1160, 1154, 1163, 1149, 1151, 1156, 1161, 1153, 1157, 1159, 1162, 1158 | Duplicate-like tasks group 54c33e529738b0d1 | operator approval required |
| archive_or_link_duplicates_after_operator_review | yes | 1026, 1029, 1027, 1028 | Duplicate-like tasks group 629d0f50054615bf | operator approval required |
...
| quarantine_until_workspace_scope_is_set | yes | 1610 | unscoped_record | operator approval required |
| attach_project_or_quarantine | yes | 1610 | orphaned_record | operator approval required |
| quarantine_until_workspace_scope_is_set | yes | 1609 | unscoped_record | operator approval required |
| attach_project_or_quarantine | yes | 1609 | orphaned_record | operator approval required |
...
| collapse_parser_fan_out_to_canonical_task | yes | 1502 | repeated_parser_fan_out | operator approval required |
| collapse_parser_fan_out_to_canonical_task | yes | 1479 | repeated_parser_fan_out | operator approval required |
| collapse_parser_fan_out_to_canonical_task | yes | 1470 | repeated_parser_fan_out | operator approval required |
| collapse_parser_fan_out_to_canonical_task | yes | 1152 | repeated_parser_fan_out | operator approval required |
| collapse_parser_fan_out_to_canonical_task | yes | 1026 | repeated_parser_fan_out | operator approval required |
