# One Time Mobile CRM IA Packet Manifest

- Parent raw: `RAW-20260713-003`
...
- Validation: `npm run pqc:validate -- ops/prompt-packets/2026-07-13-onetime-mobile-crm-ia/00-mobile-crm-ia.product-quality.json`
- Status: validated and ready for scoped `REQ-20260713-909` implementation.

## Protocol Markers

- Ramble Router classification: PRODUCT_QUALITY, UI_IMPLEMENTATION, CRM_PIPELINE, SECURITY_PRIVACY.
- Product Quality Compiler expanded phrase: CRM means the first-party One Time contact workspace with explicit mobile list/detail/subview/action states.
...
- Definition of Ready: current-state visual audit and PQC validation passed before implementation.
...
- Ramble Router classification: PRODUCT_UI_IMPLEMENTATION_PACKET.
...
- Provider setup is out of scope for this UI packet and remains approval-gated in separate provider/setup lanes.
