...
| Latest video / older library views | Partial - read-only admin/review/anonymous gates verified | `public/one-time-classroom.html`, `public/member-library.html`, `public/one-time-parent.html`, `public/student.html`, shared review data; `scripts/smoke-one-time-classroom-library-readonly-live.mjs`. | Live read-only smoke proved admin packages with library items, safe review `today_video`, and anonymous 401 gates at One Time SHA `43f7c33733880745d8f1191c86fe8e196ef68baa`; still needs approved member/access-code entitlement proof and eventual Vimeo-origin publication proof. |
