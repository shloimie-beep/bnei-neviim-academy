...
| content | Find Latest Media | `find_latest_uploaded_media` | super_admin, admin, bna_admin, operator, system | Find the newest uploaded video/audio/media record available for weekly update drafting. | wired |
| telegram | Find Latest Media | `find_latest_uploaded_media` | super_admin, admin, bna_admin, operator, system | Find the newest uploaded video/audio/media record available for weekly update drafting. | wired |
| ui_bot | Find Latest Media | `find_latest_uploaded_media` | super_admin, admin, bna_admin, operator, system | Find the newest uploaded video/audio/media record available for weekly update drafting. | wired |
| content | Check Transcript | `transcribe_or_parse_media_if_needed` | super_admin, admin, bna_admin, operator, system | Check whether the latest uploaded media needs transcription or parsing before parent-ready drafting. | wired |
| telegram | Check Transcript | `transcribe_or_parse_media_if_needed` | super_admin, admin, bna_admin, operator, system | Check whether the latest uploaded media needs transcription or parsing before parent-ready drafting. | wired |
| ui_bot | Check Transcript | `transcribe_or_parse_media_if_needed` | super_admin, admin, bna_admin, operator, system | Check whether the latest uploaded media needs transcription or parsing before parent-ready drafting. | wired |
| content | Summarize Topics | `summarize_weekly_topics` | super_admin, admin, bna_admin, operator, system | Summarize weekly topics from permitted source text or media transcript. | wired |
| telegram | Summarize Topics | `summarize_weekly_topics` | super_admin, admin, bna_admin, operator, system | Summarize weekly topics from permitted source text or media transcript. | wired |
| ui_bot | Summarize Topics | `summarize_weekly_topics` | super_admin, admin, bna_admin, operator, system | Summarize weekly topics from permitted source text or media transcript. | wired |
| content | Extract Questions | `extract_student_questions` | super_admin, admin, bna_admin, operator, system | Extract parent-visible student questions from permitted source text or media transcript. | wired |
| telegram | Extract Questions | `extract_student_questions` | super_admin, admin, bna_admin, operator, system | Extract parent-visible student questions from permitted source text or media transcript. | wired |
| ui_bot | Extract Questions | `extract_student_questions` | super_admin, admin, bna_admin, operator, system | Extract parent-visible student questions from permitted source text or media transcript. | wired |
| content | Generate Newsletter | `generate_parent_newsletter` | super_admin, admin, bna_admin, operator, system | Generate a parent-ready newsletter draft from the weekly update context without sending email. | wired |
| communications | Generate Newsletter | `generate_parent_newsletter` | super_admin, admin, bna_admin, operator, system | Generate a parent-ready newsletter draft from the weekly update context without sending email. | wired |
| telegram | Generate Newsletter | `generate_parent_newsletter` | super_admin, admin, bna_admin, operator, system | Generate a parent-ready newsletter draft from the weekly update context without sending email. | wired |
| content | Generate Weekly WhatsApp | `generate_whatsapp_weekly_post` | super_admin, admin, bna_admin, operator, system | Generate a concise WhatsApp parent-group draft from the weekly update context without sending it. | wired |
| communications | Generate Weekly WhatsApp | `generate_whatsapp_weekly_post` | super_admin, admin, bna_admin, operator, system | Generate a concise WhatsApp parent-group draft from the weekly update context without sending it. | wired |
| telegram | Generate Weekly WhatsApp | `generate_whatsapp_weekly_post` | super_admin, admin, bna_admin, operator, system | Generate a concise WhatsApp parent-group draft from the weekly update context without sending it. | wired |
| content | Attach Video | `attach_video_to_parent_portal` | super_admin, admin, bna_admin, operator, system | Prepare a parent-visible video/image attachment for the weekly update after approval. | wired |
| parent_detail | Attach Video | `attach_video_to_parent_portal` | super_admin, admin, bna_admin, operator, system | Prepare a parent-visible video/image attachment for the weekly update after approval. | wired |
| student_detail | Attach Video | `attach_video_to_parent_portal` | super_admin, admin, bna_admin, operator, system | Prepare a parent-visible video/image attachment for the weekly update after approval. | wired |
| content | Save Weekly Update Revision | `save_weekly_update_revision` | super_admin, admin, bna_admin, operator, system | Save a revised weekly parent update draft with parent-portal metadata. | wired |
| parent_detail | Save Weekly Update Revision | `save_weekly_update_revision` | super_admin, admin, bna_admin, operator, system | Save a revised weekly parent update draft with parent-portal metadata. | wired |
| student_detail | Save Weekly Update Revision | `save_weekly_update_revision` | super_admin, admin, bna_admin, operator, system | Save a revised weekly parent update draft with parent-portal metadata. | wired |
