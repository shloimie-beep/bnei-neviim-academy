# Normalize visible One Time brand display copy

## Packet Identity

- Parent raw ID: RAW-20260710-001
- Expected packet ID: chatgpt-onetime-brand-copy-normalization-20260710
- Lane key: window-03-chatgpt-onetime-brand-copy-normalization-20260710
...
`ops/chatgpt-ramble-dropoff/incoming/chatgpt-onetime-brand-copy-normalization-20260710/`
...
### UIGAP-20260710-002 - Visible brand display text still uses OneTimeOneTime

- Severity: P2
- Routes: /one-time, /provider.html?review=one-time, /student/login, /rabbi-member
- Screenshots: SS-20260710-001, SS-20260710-005, SS-20260710-008
- Acceptance:
  - Visible product label follows the durable One Time / One Time Mishnah naming rule unless config explicitly says otherwise.
  - Domain/email values such as onetimeonetime.com are not rewritten as display names.
  - Static tests or readbacks cover public, provider, member, student, and email/review copy surfaces.
...
`PACKET_PATH: ops/chatgpt-ramble-dropoff/incoming/chatgpt-onetime-brand-copy-normalization-20260710/`
`GAP_IDS: UIGAP-20260710-002`
