# ChatGPT Window 03: Frontend And Workflow Implementation Bundle
...
- Prompt ID: `20260709-chatgpt-multi-window-and-kimi-fallback-03-frontend-workflow-bundle`
- Packet ID to create: `20260709-chatgpt-multi-window-and-kimi-fallback-03-frontend-workflow-bundle`
- Packet role: `implementation_bundle_frontend_workflow`
- Owner: `ChatGPT-window-03`
- Workspace: `bna_platform`
- Project: `general`
- Lane key: `bna-platform-general-frontend-workflow-bundle`

## Scope

Draft focused frontend, UI workflow, route, prompt, or operator-experience changes only for this lane. Do not touch backend/data/provider setup unless the prompt explicitly scopes it.
...
`ops/chatgpt-ramble-dropoff/incoming/20260709-chatgpt-multi-window-and-kimi-fallback-03-frontend-workflow-bundle/`
...
A repo-visible implementation_bundle packet with PATCHES.md or precise diffs, files inspected, tests expected, action/route registry impacts, and handback rules.
