# ChatGPT Window 01: Control Tower And Source Map
...
- Prompt ID: `20260709-chatgpt-multi-window-and-kimi-fallback-01-control-tower-source-map`
- Packet ID to create: `20260709-chatgpt-multi-window-and-kimi-fallback-01-control-tower-source-map`
- Packet role: `control_tower_source_map`
- Owner: `ChatGPT-window-01`
- Workspace: `bna_platform`
- Project: `general`
- Lane key: `bna-platform-general-control-tower-source-map`

## Scope

Preserve the raw source, classify the ramble, split it into child packet lanes, map source statements to requirements, and identify duplicates/blockers.
...
`ops/chatgpt-ramble-dropoff/incoming/20260709-chatgpt-multi-window-and-kimi-fallback-01-control-tower-source-map/`
...
A repo-visible prompt_packet or current_state_audit packet that contains the parent source map, child lane list, dependency order, and one recommended next packet.
