...
Packet ID: onetime-agent-prompt-series-20260706-911
Raw source: RAW-20260706-911
Workspace/project: rabbi_sheller_provider / one_time_mishnah_class

This packet is a ChatGPT meta‑prompt to create a series of Agent Mode audit prompts for the One Time system.  The raw source comes from the meta prompt in `ops/prompt-packets/2026-07-06-onetime-full-ui-agent-audit/00-chatgpt-meta-prompt.md`.
