# No-Write Live Smoke Readback - 2026-07-12T08:36:45Z
...
- PASS `npm run app:smoke:rabbi-onetime-landing -- https://join.onetimeonetime.com`
  - Local ignored report: `ops/live-smokes/2026-07-12T08-36-21-853Z-rabbi-onetime-landing-smoke.md`.
...
- PASS `npm run app:smoke:one-time-interest-dry-run`
  - Local ignored report: `ops/live-smokes/2026-07-12T08-36-21-908Z-one-time-interest-dry-run-live-smoke.md`.
  - Local ignored JSON: `ops/live-smokes/2026-07-12T08-36-21-908Z-one-time-interest-dry-run-live-smoke.json`.
  - Verified public form endpoint and dry-run lead-capture mapping without writes.
- PASS `npm run app:smoke:public-privacy`
  - Local ignored report: `ops/live-smokes/2026-07-12T08-36-33-417Z-public-route-privacy-smoke.md`.
