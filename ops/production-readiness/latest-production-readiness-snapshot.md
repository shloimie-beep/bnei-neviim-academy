# Production Readiness Snapshot - 2026-07-10T16:46:07.528Z
...
- Branch: unknown
- HEAD: 74bdce15
- origin/master: 74bdce15
- Worktree clean when sampled: yes

## Snapshot Freshness
- Kind: sampled_control_tower_report
- Sampled git head: 74bdce15
- Sampled origin/master: 74bdce15
...
- Status: passed
- Ready: yes
- Fresh for launch gate: yes (0.04h old, max 24h)
- Commands passed: 4/4
...
- Queue health: fresh 0, stale 518, blocked 155, unknown 221, do-not-redo 830
...
- job #344 / task #1736 [blocked_needs_human_decision] Repair Agent Mode result AGR-19cfa47542407167 (local_lock=stale_lock_dead_pid pid=105512 heartbeat=2026-07-02T12:39:01.959Z age_hours=196.12 path=.runtime/agent-fleet/task-1736.lock.json)
