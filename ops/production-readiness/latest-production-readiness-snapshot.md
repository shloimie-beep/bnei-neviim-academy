# Production Readiness Snapshot - 2026-07-10T14:46:16.040Z
...
- Branch: master
- HEAD: abce44b5
- origin/master: abce44b5
- Worktree clean when sampled: no

## Snapshot Freshness
- Kind: sampled_control_tower_report
- Sampled git head: abce44b5
- Sampled origin/master: abce44b5
...
- Status: passed
- Ready: yes
- Fresh for launch gate: yes (21.18h old, max 24h)
- Commands passed: 4/4
...
- Queue health: fresh 4, stale 513, blocked 130, unknown 192, do-not-redo 887
...
- job #344 / task #1736 [blocked_needs_human_decision] Repair Agent Mode result AGR-19cfa47542407167 (local_lock=stale_lock_dead_pid pid=105512 heartbeat=2026-07-02T12:39:01.959Z age_hours=194.12 path=.runtime/agent-fleet/task-1736.lock.json)
