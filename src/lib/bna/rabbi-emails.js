function rabbiTemplateSubject(templateKey, context = {}) {
  ...
  const titles = {
    ...
    parent_trial_invite: `Welcome to ${program} - your 30-day access is ready`,
...
function rabbiTemplateBody(templateKey, context = {}) {
  ...
  const lines = {
    ...
    parent_trial_invite: [
      ...
      '',
      'Your 30-day access is ready. Start by setting your parent password, then use the class and library links below whenever you need them.',
      '',
