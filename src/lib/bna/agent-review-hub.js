...
const AGENT_MODE_PROMPTS = [
  ...
  },
  {
    ...
    exact_navigation: [
      ...
      'Open the One Time Helper on /one-time. Ask three public-safe questions: class schedule, promotional parent access, and library access. Verify answers stay in one_time_mishnah_class scope and do not mention BNA school accountability unless explicitly framed as unrelated.',
