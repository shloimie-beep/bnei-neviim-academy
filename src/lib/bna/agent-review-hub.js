...
const AGENT_MODE_PROMPTS = [
  ...
  },
  {
    ...
    exact_navigation: [
      ...
      'Inspect the campaign countdown. It must use /api/one-time/campaign or explicit config, be Israel-time / Asia/Jerusalem, and point toward Rosh Hashanah / the new year rather than a generic resettable 30-day timer.',
  ...
  },
  {
    ...
    exact_navigation: [
      ...
      'Compare header contracts: sticky or stable placement, black/charcoal background, large logo, brand text OneTimeOneTime Mishnah / Worldwide Live Mishnayos, public nav labels, member/classroom nav labels, active yellow nav with black text, and inactive dark/cream/yellow styling.',
