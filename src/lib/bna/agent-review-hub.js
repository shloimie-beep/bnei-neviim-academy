...
const AGENT_MODE_PROMPTS = [
  ...
  },
  {
    ...
    exact_navigation: [
      ...
      'Open Communications, then Email. If visible, click Rabbi / One Time or View Rabbi / One Time Inbox and confirm the panel says Now Viewing: Rabbi / One Time Inbox or shows info@onetimeonetime.com.',
      ...
      'In the provider/Rabbi route, inspect mailbox, contacts/CRM, class media, WhatsApp setup, support, and dashboard areas. Rabbi view must be OneTime-branded, scoped to rabbi_sheller_provider / one_time_mishnah_class, and free of BNA Academy branding.',
      ...
      'Open /provider.html?review=one-time, /parent.html?review=one-time, /student.html?review=one-time, /rabbi-member.html?review=one-time, and /one-time-classroom.html?review=one-time&code=TEST-ONETIME-REVIEW-ACCESS only after the visible click path has been attempted.',
