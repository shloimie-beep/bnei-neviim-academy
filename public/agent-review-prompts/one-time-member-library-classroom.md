...
```json
{
  ...
  "prompt_key": "one-time-member-library-classroom",
  "context_key": null,
  "public_prompt_url": "https://join.onetimeonetime.com/agent-review-prompts/one-time-member-library-classroom.md",
  "public_artifacts": [],
  "return_url": "https://bneineviimacademy.org/operations/agent-review?prompt=one-time-member-library-classroom",
  ...
  "idempotency_key": "2026-06-26-agent-review-dropoff-repair:one-time-member-library-classroom:all-contexts"
}
```

## Start

Open this public prompt first: https://join.onetimeonetime.com/agent-review-prompts/one-time-member-library-classroom.md
...
Public prompt URL: https://join.onetimeonetime.com/agent-review-prompts/one-time-member-library-classroom.md
