...
```json
{
  ...
  "context_key": null,
  "public_prompt_url": "https://join.onetimeonetime.com/agent-review-prompts/rabbi-telegram-helper-ticket-smoke.md",
  "public_artifacts": [],
...
Open this public prompt first: https://join.onetimeonetime.com/agent-review-prompts/rabbi-telegram-helper-ticket-smoke.md
...
Public prompt URL: https://join.onetimeonetime.com/agent-review-prompts/rabbi-telegram-helper-ticket-smoke.md
...
6. Open Communications > Email or /operations?workspace=rabbi_sheller_provider&project=one_time_mishnah_class&view=communications&section=email. Confirm Rabbi / One Time email is visibly separated from Shloimie/BNA email and no unrelated BNA inbox is shown as the active Rabbi inbox.
7. Open Communications > WhatsApp or /operations?workspace=rabbi_sheller_provider&project=one_time_mishnah_class&view=communications&section=whatsapp. Confirm WAPI/Rabbi communications are scoped to One Time and outbound sends remain blocked unless explicitly approved. Do not send a WhatsApp message.
