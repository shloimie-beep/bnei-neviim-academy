...
```json
{
  ...
  "context_key": null,
  "public_prompt_url": "https://join.onetimeonetime.com/agent-review-prompts/navigation-ia-duplicate-control-audit.md",
  "public_artifacts": [],
...
Open this public prompt first: https://join.onetimeonetime.com/agent-review-prompts/navigation-ia-duplicate-control-audit.md
...
Public prompt URL: https://join.onetimeonetime.com/agent-review-prompts/navigation-ia-duplicate-control-audit.md
