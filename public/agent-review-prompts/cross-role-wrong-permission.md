...
Return URL: https://bneineviimacademy.org/operations/agent-review?prompt=cross-role-wrong-permission
...
```json
{
  ...
  "context_key": null,
  "public_prompt_url": "https://join.onetimeonetime.com/agent-review-prompts/cross-role-wrong-permission.md",
  "public_artifacts": [],
  "return_url": "https://bneineviimacademy.org/operations/agent-review?prompt=cross-role-wrong-permission",
  ...
  "idempotency_key": "2026-06-26-agent-review-dropoff-repair:cross-role-wrong-permission:all-contexts"
}
```

## Start

Open this public prompt first: https://join.onetimeonetime.com/agent-review-prompts/cross-role-wrong-permission.md
...
Public prompt URL: https://join.onetimeonetime.com/agent-review-prompts/cross-role-wrong-permission.md
