# Agent Mode Prompt - One Time Public Landing Million-Dollar Audit
...
```json
{
  ...
  "prompt_key": "one-time-public-landing-million-dollar-audit",
  "context_key": null,
  "public_prompt_url": "https://join.onetimeonetime.com/agent-review-prompts/one-time-public-landing-million-dollar-audit.md",
  "public_artifacts": [],
  "return_url": "https://bneineviimacademy.org/operations/agent-review?prompt=one-time-public-landing-million-dollar-audit",
  ...
  "idempotency_key": "2026-06-26-agent-review-dropoff-repair:one-time-public-landing-million-dollar-audit:all-contexts"
}
```

## Start

Open this public prompt first: https://join.onetimeonetime.com/agent-review-prompts/one-time-public-landing-million-dollar-audit.md
...
Public prompt URL: https://join.onetimeonetime.com/agent-review-prompts/one-time-public-landing-million-dollar-audit.md
...
8. Check for BNA brand bleed: BNA Academy copy, BNA colors, Hebrew/English toggle, school-goals language, unrelated helper language, GHL, LeadConnector, or Operations/admin content.
9. Check helper placement. The helper launcher/panel must not cover the public CTA or form on mobile or desktop.
10. Save PASS, FAIL, or BLOCKED through Agent Review drop-off as soon as evidence is enough. Do not ask the operator whether to seal the run.
