...
Return URL: https://bneineviimacademy.org/operations/agent-review?prompt=parent-portal
...
```json
{
  ...
  "prompt_key": "parent-portal",
  "context_key": null,
  "public_prompt_url": "https://join.onetimeonetime.com/agent-review-prompts/parent-portal.md",
  "public_artifacts": [],
  "return_url": "https://bneineviimacademy.org/operations/agent-review?prompt=parent-portal",
...
Open this public prompt first: https://join.onetimeonetime.com/agent-review-prompts/parent-portal.md
...
Public prompt URL: https://join.onetimeonetime.com/agent-review-prompts/parent-portal.md
