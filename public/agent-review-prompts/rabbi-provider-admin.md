...
```json
{
  ...
  "context_key": null,
  "public_prompt_url": "https://join.onetimeonetime.com/agent-review-prompts/rabbi-provider-admin.md",
  "public_artifacts": [],
...
Open this public prompt first: https://join.onetimeonetime.com/agent-review-prompts/rabbi-provider-admin.md
...
Public prompt URL: https://join.onetimeonetime.com/agent-review-prompts/rabbi-provider-admin.md
...
9. In the provider/Rabbi route, inspect mailbox, contacts/CRM, class media, Communications > Email, Communications > WhatsApp, support, and dashboard areas. Rabbi view must be One Time branded, scoped to rabbi_sheller_provider / one_time_mishnah_class, and free of BNA Academy branding.
