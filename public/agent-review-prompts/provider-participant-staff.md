...
```json
{
  ...
  "context_key": null,
  "public_prompt_url": "https://join.onetimeonetime.com/agent-review-prompts/provider-participant-staff.md",
  "public_artifacts": [],
...
Open this public prompt first: https://join.onetimeonetime.com/agent-review-prompts/provider-participant-staff.md
...
Public prompt URL: https://join.onetimeonetime.com/agent-review-prompts/provider-participant-staff.md
