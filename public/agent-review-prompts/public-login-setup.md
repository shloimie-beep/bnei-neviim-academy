...
```json
{
  ...
  "context_key": null,
  "public_prompt_url": "https://join.onetimeonetime.com/agent-review-prompts/public-login-setup.md",
  "public_artifacts": [],
...
Open this public prompt first: https://join.onetimeonetime.com/agent-review-prompts/public-login-setup.md
...
Public prompt URL: https://join.onetimeonetime.com/agent-review-prompts/public-login-setup.md
