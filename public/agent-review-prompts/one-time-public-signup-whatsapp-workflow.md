...
```json
{
  ...
  "context_key": null,
  "public_prompt_url": "https://join.onetimeonetime.com/agent-review-prompts/one-time-public-signup-whatsapp-workflow.md",
  "public_artifacts": [],
...
Open this public prompt first: https://join.onetimeonetime.com/agent-review-prompts/one-time-public-signup-whatsapp-workflow.md
...
Public prompt URL: https://join.onetimeonetime.com/agent-review-prompts/one-time-public-signup-whatsapp-workflow.md
