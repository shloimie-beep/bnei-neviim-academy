// Deferred renderers extracted from public/operations.html for lighter initial /operations delivery.
        ...
        function renderEmailOperatorWorkspace(emailRecords = []) {
            ...
            return `
                <section class="focus-panel" data-email-operator-workspace>
                    <div class="task-section-header">
                        <div>
                            <h3>Email Workspace</h3>
                            <p class="settings-disabled-note one-time-email-workspace-intro">Drafts, logged emails, sender readiness, DNS tasks, and approval gates stay first-party. No email is sent from this lane without the exact SEND_RESEND_EMAIL phrase.</p>
                        </div>
