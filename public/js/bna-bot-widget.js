  ...
  function surfaceConfig() {
    ...
    if (surface === 'one_time_parent') {
      return {
        ...
        intro: "Hi, I'm Robot Scheller, Rabbi Scheller's digital assistant. I can help with promotional access, class schedule, child access, attendance questions, and how to ask Rabbi Scheller a class question. I do not show private billing records, other families, student transcripts, access codes, or admin data.",
        cards: [
        ...
        prompts: [
          'What should I do while promotional access is active?',
