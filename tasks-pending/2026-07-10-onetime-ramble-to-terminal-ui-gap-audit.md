...
- Manual review: reopened concrete UI gaps for mobile nav clipping, brand/copy, and provider text fit; mobile nav, provider text fit, and brand/copy are now deployed/live-proven for the scoped public/member/classroom/provider surfaces.
