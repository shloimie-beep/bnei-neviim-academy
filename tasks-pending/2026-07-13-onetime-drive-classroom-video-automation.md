...
| REQ-20260713-915 | `src/lib/bna/one-time-vimeo-studio-pipeline.js`, `src/lib/bna/one-time-vimeo-folder-library.js`, `tests/one-time-vimeo-studio-pipeline.test.js`, `tests/one-time-vimeo-folder-library-workflow.test.js` | Set default opener to zero unless explicitly requested; preserved explicit sidecar/CLI opener support; added `.mkv` support through studio and folder-library handoff; skip opener render/concat when opener is zero; added rendered-output verification with SHA-256, expected/probed duration, dimensions, audio, and tolerance evidence. | `node --test tests/one-time-vimeo-studio-pipeline.test.js tests/one-time-vimeo-folder-library-workflow.test.js` passed 24/24 including real local FFmpeg render smoke; syntax checks passed. | pending | pending | not required unless bundled with server-visible deployment |
| REQ-20260713-916 | `src/lib/bna/one-time-long-transcription.js`, `tests/one-time-long-transcription.test.js`, `server.js` | Added One Time-specific long-form transcription harness for overlapping chunk plans, audio extraction command plans, timestamp merge/dedupe, retry/dead-letter chunk states, private transcript version records, hashes, safe reports, and expanded transcript lifecycle statuses. | `node --test tests/one-time-long-transcription.test.js` passed 7/7; syntax check passed; safe report tests prove private transcript body is omitted. | pending | pending | provider call/private fixture integration pending |
| REQ-20260713-917 | `src/lib/bna/one-time-transcript-metadata.js`, `tests/one-time-transcript-metadata.test.js` | Added versioned metadata draft and bot-knowledge handoff contracts with title/Torah field extraction, confidence/review rules, transliteration, sidecar priority, approval gates, provider-scoped private handoff, and no raw transcript body in handoff. | `node --test tests/one-time-transcript-metadata.test.js` passed 5/5; syntax check passed. | pending | pending | DB promotion worker/review UI integration pending |
...
| REQ-20260713-915 | In progress | `ops/prompt-packets/2026-07-13-onetime-drive-classroom-video-automation/03-media-edit-and-long-transcription.md` | Studio/folder media workflow code and tests | Media workflow tests passed 24/24 with a real local FFmpeg render smoke proving no default opener and output verification. | Commit/push still pending; long-form transcription remains separate REQ-20260713-916. |
| REQ-20260713-916 | In progress | `ops/prompt-packets/2026-07-13-onetime-drive-classroom-video-automation/03-media-edit-and-long-transcription.md` | New long-transcription harness and transcript status schema update | Long-transcription tests passed 7/7; safe report omits transcript bodies. | Provider integration/private fixture run, commit/push, and any release/readback remain pending. |
| REQ-20260713-917 | In progress | `ops/prompt-packets/2026-07-13-onetime-drive-classroom-video-automation/04-transcript-metadata-and-knowledge-handoff.md` | Metadata/handoff module and tests | Metadata tests passed 5/5; approved handoff omits raw transcript body and remains provider-scoped. | DB promotion worker/review UI integration, commit/push, and release/readback remain pending. |
