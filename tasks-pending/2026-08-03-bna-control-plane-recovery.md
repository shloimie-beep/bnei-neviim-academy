...
|---|---|---|---|---|
| Q-20260803-001 | Does the current Railway worker still own the academy bot token and verified Shloimie chat binding, or is a distinct PR #142 token namespace configured? | Selects academy bridge vs isolated Operations bot without token collision. | yes for canary/deploy; no for local code/UI work | Resolved: canonical Railway Academy bridge owns the proven BNA bot/chat mapping. |
...
|---|---|---|---|---|---|---|
| BNA-CTRL-001 | Academy bridge/notifier/runtime helpers; task capture/API; Operations UI; event contract; tests/runbook/evidence. | Minimal reconciliation and live canary completed on the fresh branch. | BNA 47/47; One Time 80/80; generated/canonical/secret/diff/live/browser gates passed. | `09aaac46528d50bf66a20ead4542f3214425ac55` | pushed | Candidate deployments healthy; final GitHub release follows the closeout commit. |

## Final audit

| ID | Status | Evidence | Files changed | Verification | Remaining issue |
|---|---|---|---|---|---|
| BNA-CTRL-001 | Done | `ops/codex-runs/2026-08-03-bna-ctrl-001/HANDOFF.md` | runtime, API/UI, contract, tests, runbook, screenshots, register/ledger/changelog | Live canary and focused release gates passed | No release blocker; separate webhook evaluation remains deferred. |
