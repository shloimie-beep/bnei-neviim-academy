...
|---|---|---|---|---|---|---|---|---|
| DEC-20260712-101 | Merge/deploy approval was granted in Codex chat for live review. | n/a | Shloimie | Deploy branch to One Time Railway service without broad sends or provider mutations. | Keep branch unmerged and continue revisions there. | Operator can review the live landing page before giving more changes. | Done: deployed `0317acc163ca7f6903e6dcf4426d95666501d504` to Railway deployment `949c5f23-8673-4922-aca5-357a90a74e19`. | REQ-20260712-107 | Done |
...
|---|---|---|---|---|---|---|
| REQ-20260712-102 | `/one-time`, `public/one-time/index.html` | Implement exact public landing order/copy/visual system. | Static tests, screenshots, and live target gate. | `0317acc163ca7f6903e6dcf4426d95666501d504` | `0317acc163ca7f6903e6dcf4426d95666501d504` | Railway `949c5f23-8673-4922-aca5-357a90a74e19`; live smokes passed |
| REQ-20260712-105 | `public/js/bna-bot-widget.js` | Render robot via contained image and verify current-class behavior. | Static tests, Playwright robot checks, and live screenshots. | `0317acc163ca7f6903e6dcf4426d95666501d504` | `0317acc163ca7f6903e6dcf4426d95666501d504` | Railway `949c5f23-8673-4922-aca5-357a90a74e19`; live screenshots captured |
| REQ-20260712-106 | `/one-time/signup`, signup workflow normalizer | Free-text city plus detected/fallback timezone. | Node/browser signup tests and live signup route smoke. | `0317acc163ca7f6903e6dcf4426d95666501d504` | `0317acc163ca7f6903e6dcf4426d95666501d504` | Railway `949c5f23-8673-4922-aca5-357a90a74e19`; live `/one-time/signup` smoke passed |
...
| REQ-20260712-107 | Deployed for live review | Railway deployment `949c5f23-8673-4922-aca5-357a90a74e19`; `/api/deploy-info` reports `0317acc163ca7f6903e6dcf4426d95666501d504`; live screenshots `ops/live-smokes/2026-07-12-onetime-landing-live-*.png`. | audit artifacts, ledger/changelog, server metadata gate | syntax checks, release-captain tests 6/6, focused One Time suite 73/73, `npm run pqc:validate`, `npm run watchdog:actions`, `npm run watchdog:protocol-drift`, `npm run app:smoke:onetime-separate-instance -- https://join.onetimeonetime.com --expected-sha 0317acc163ca7f6903e6dcf4426d95666501d504`, `npm run app:smoke:rabbi-onetime-landing -- https://join.onetimeonetime.com`, `npm run one-time:target:guard` | operator may request next revisions |
