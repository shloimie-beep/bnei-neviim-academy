...
- Nine terminal mapping batches are recorded in
  `historical-source-statement-matrix.json`: the first eight batches plus
  the twenty July 8 parent invite/Agent Review/classroom/media/Vimeo/signup/runtime
  rows now have terminal or active statuses; 177 rows still lack terminal
  status.
