...
- Thirteen terminal mapping batches are recorded in
  `historical-source-statement-matrix.json`: the first twelve batches plus
  the June 14-15 workspace/helper/classroom/payments/assistant
  rows now have terminal or active statuses; 113 rows still lack terminal
  status.
