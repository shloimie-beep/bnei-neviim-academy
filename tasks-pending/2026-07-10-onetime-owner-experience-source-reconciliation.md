...
- Fourteen terminal mapping batches are recorded in
  `historical-source-statement-matrix.json`: the first thirteen batches plus
  the June 16 agent-work/community/helper/integrations/watchdog/website
  rows now have terminal or active statuses; 97 rows still lack terminal
  status.
