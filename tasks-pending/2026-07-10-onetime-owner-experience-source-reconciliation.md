...
- Nineteen terminal mapping batches are recorded in
  ...
  rows now have terminal or active statuses; 39 rows still lack terminal
  status, including 38 non-active rows still requiring mapping.
