...
3. The 18 wrapper-backed contracts are committed, pushed, deployed, and prompt
   readback verified, but still need saved Agent Mode PASS/BLOCKED proof before
...
8. External-write, financial/access, credential, upload, DNS/account, publish,
   ...
   gates exist.
9. Agent Mode has not yet saved a PASS/BLOCKED/FAIL drop-off result for the
   all-163 probe run.
