...
5. The 27 wrapper-backed contracts still need saved Agent Mode PASS/BLOCKED
   proof before autonomy can be claimed; the read-only batch also still needs
   commit/push/deploy/live-smoke closeout.
