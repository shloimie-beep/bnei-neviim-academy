...
| Next requirement IDs to work | `REQ-20260624-021` integrate lane branches with checkpoint commits |
...
| REQ-20260624-021 | lane branches/shared patches | Merge lanes with focused tests and checkpoint commits. | In progress | pending | pending | not applicable |
