...
| Next requirement IDs to work | `REQ-20260624-023` shared route, UI, and server authorization wiring |
...
| REQ-20260624-023 | routes/UI/auth | Integrate shared route/UI requests and verify authorization. | In progress: shared patches reviewed; server/UI wiring remains next. | pending | pending | required later |
