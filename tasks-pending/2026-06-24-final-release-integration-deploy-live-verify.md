...
| Next requirement IDs to work | `REQ-20260624-024` migration and database readiness review |
...
| REQ-20260624-024 | migrations/schema | Dry-run/backup/rollback/readiness before any apply. | In progress: next active batch; no production DB mutation authorized. | pending | pending | required if applied |
