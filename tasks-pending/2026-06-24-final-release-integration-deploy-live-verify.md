...
| Next requirement IDs to work | `REQ-20260624-030` canonical records closeout |
...
| REQ-20260624-030 | Update canonical records, owner-review links, rollback reference, and final release state. | RAW-20260624-005 | bna_platform / final_release | Codex | canonical_records | P0 | L | REQ-20260624-026, REQ-20260624-027 | Active run, this register, tasks, Decisions, `MEMORY.md`, `TASKS.md`, changelog, ledger, source truth, owner-review report, deployment evidence, live-smoke evidence, setup walkthrough links, next-session instructions, and true remaining blockers are updated and pushed. | canonical docs/ledgers/run files | no | In progress |
...
| REQ-20260624-030 | canonical records | Update and push final release records. | In progress: run files, register, TASKS, changelog, and ledger are being updated. | pending | pending | not applicable |
