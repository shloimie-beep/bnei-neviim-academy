...
| Vertical CRM implementation packets | Previous CRM implementation covers DTO/list/workbench/inbox context; packet asks for OT-CRM-01 through OT-CRM-05 ownership and canonical-route mutation proof. | Done. Safe CRM endpoints, split-shell client methods, route/action registry rows, canonical `/operations` proof, isolated Railway `crm-test` Postgres mutation/reload proof, and deployed read-only CRM live smoke passed with no send/import/payment/access/DNS/secret mutation. | REQ-20260712-806 |
| Deploy/live closeout | Live SHA is `48c52797b`, while current `origin/master` is `593b85c7f`; app-visible/server-visible deltas must be deployed and live-smoked after verification. | Done. `one-time-web` deployment `3ea1e251-67aa-4137-85cc-82d38437ab8d` reached SUCCESS and SHA-pinned smoke confirmed commit `467ff7f25aa0a2fa9931cdb4fde6cd264cf4eeb8`. | REQ-20260712-807 |
...
| REQ-20260712-806 | Split CRM Contacts/Inbox work into OT-CRM-01 through OT-CRM-05 current-state packets and implement only missing/partial rows in dependency order. | REQ-20260711-005 / REQ-20260712-107 | Codex | crm_implementation | P0 | delta-C1-C9 | REQ-20260712-805 | yes | Done |
...
| REQ-20260712-806 | `server.js`, `public/js/operations-shell.js`, `public/operations.html`, `scripts/smoke-onetime-crm-journey-local-db.mjs`, registry/spec rows, Railway `crm-test` Postgres service `Postgres-ib9s` | Implemented safe local-only CRM mutations/readbacks, fixed fresh-db bootstrap ordering, aligned the CRM mailbox action to `ACTION-CRM-CONTACT-MAILBOX-OPEN`, and proved persistence/reload/inbox return on an isolated Railway test DB. | PASS focused CRM/unit tests 27/27; PASS Railway-backed CRM journey smoke with report `ops/evidence/one-time-crm-journey-local-db/2026-07-13T03-31-54-271Z-report.md`; PASS read-only live CRM workbench smoke. | `467ff7f25aa0a2fa9931cdb4fde6cd264cf4eeb8` | `origin/codex/onetime-post-agent-delta-20260712-v3` | Railway `one-time-production / production / one-time-web` deployment `3ea1e251-67aa-4137-85cc-82d38437ab8d` reached SUCCESS; live CRM report `ops/live-smokes/2026-07-13T03-42-40-981Z-one-time-operations-crm-workbench-live-smoke.md`. |
| REQ-20260712-807 | Run register, ledger, changelog, Railway one-time-web deployment, and live-smoke evidence | Published commit `467ff7f25aa0a2fa9931cdb4fde6cd264cf4eeb8`, deployed `one-time-web`, and captured SHA-pinned public route smoke plus read-only Operations CRM live smoke. | PASS `npm run one-time:target:guard`; PASS `npm run app:smoke:onetime-separate-instance -- https://join.onetimeonetime.com --expected-sha 467ff7f25aa0a2fa9931cdb4fde6cd264cf4eeb8`; PASS `npm run app:smoke:onetime-operations-crm-workbench`; PASS final `npm run bna:run:validate`. | `467ff7f25aa0a2fa9931cdb4fde6cd264cf4eeb8` | `origin/codex/onetime-post-agent-delta-20260712-v3` | Railway deployment `3ea1e251-67aa-4137-85cc-82d38437ab8d`; docs-only closeout commit follows. |
...
| REQ-20260712-806 | Done | Safe implementation slice plus Railway `crm-test` isolated mutation/reload proof: `Postgres-ib9s` (`ebbb512e-3d27-44e1-a85b-4be3871a6b2f`) in environment `crm-test` (`2a9b61fa-6d88-4405-b6d6-0120ff7f461f`), report `ops/evidence/one-time-crm-journey-local-db/2026-07-13T03-31-54-271Z-report.md`, screenshot `ops/evidence/one-time-crm-journey-local-db/2026-07-13T03-31-54-271Z-crm-mailbox-roundtrip.png`, and live report `ops/live-smokes/2026-07-13T03-42-40-981Z-one-time-operations-crm-workbench-live-smoke.md`. | `server.js`, `public/js/operations-shell.js`, `public/operations.html`, `scripts/smoke-onetime-crm-journey-local-db.mjs`, `scripts/smoke-onetime-operations-crm-workbench-local.mjs`, registry/spec rows, focused guard test. | PASS syntax checks; PASS focused CRM/unit tests 27/27; PASS JSON parse for registry/spec packet rows; PASS Railway-backed CRM journey smoke; PASS Railway deploy/live CRM smoke. | None for this scoped slice. |
| REQ-20260712-807 | Done | Final deploy/live closeout: commit `467ff7f25aa0a2fa9931cdb4fde6cd264cf4eeb8`, Railway deployment `3ea1e251-67aa-4137-85cc-82d38437ab8d`, SHA-pinned public route smoke, read-only Operations CRM live smoke, ledger/changelog/status updates. | Run register, ledger, changelog, deploy evidence, live smoke report. | PASS final validation, deploy, target guard, SHA-pinned smoke, and read-only CRM live smoke. | Repo-wide audit-governance report still shows pre-existing audit mapping debt, not a blocker for this scoped run. |
