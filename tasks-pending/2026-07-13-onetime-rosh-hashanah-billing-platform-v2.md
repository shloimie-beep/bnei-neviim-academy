...
| Next requirement IDs to work | `REQ-20260713-963`; branch head `2005bd590068825521a3485835d38798758433f5` is pushed, PR #132 is draft/open and `CLEAN`, hosted One Time Railway Stripe sandbox readback is ready after guarded propagation, and release handoff/final-report proof is current. Deploy/live smoke, exact `billing_start_at`, final notice approval, final live Stripe approval, and explicit launch authorization still block terminal Done for app-visible/live activation work. |
...
| `08-release-handoff` | `REQ-20260713-962`, `REQ-20260713-963` | DEPLOY_PACKET | `07` | draft_pr_mergeable_live_blocked | branch pushed, draft PR/handoff created, PR merge state clean, live activation blockers explicit |
...
| `REQ-20260713-951` | Partial local verified / pushed | Correction map plus active billing/product/runtime policy changes | Focused Stripe/local beta tests pass; old trial evidence preserved as provenance | broader old-term audit remains before terminal Done |
...
| `REQ-20260713-955` | Sandbox verified / hosted config ready | Lifecycle/webhook tests, sandbox smoke reports, hosted Railway readback/propagation reports | `npm run stripe:sandbox-smoke`; `npm run stripe:railway-readback` ready 2/2 | deployed webhook delivery/live smoke still pending |
...
| `REQ-20260713-961` | Local/hosted sandbox verified / pushed | Sandbox E2E verifier, timestamped/latest reports, Railway readback/propagation reports | `npm run stripe:sandbox-e2e`; focused Billing verifier suite 14/14; `npm run stripe:railway-readback` ready 2/2 | no live blocker; deployed webhook smoke remains under release/deploy gate |
| `REQ-20260713-962` | Draft PR/handoff current / live blocked | Release handoff with final-report sections, PR #132, branch head `2005bd590068825521a3485835d38798758433f5` | GitHub PR #132 is draft/open and `CLEAN` against master `43f7c33733880745d8f1191c86fe8e196ef68baa` | deploy/live smoke remains pending before app-visible terminal Done |
