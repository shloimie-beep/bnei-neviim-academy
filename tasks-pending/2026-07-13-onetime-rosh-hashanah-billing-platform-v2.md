...
| `04-stripe-runtime-webhooks-and-invoices` | `REQ-20260713-955` | IMPLEMENTATION_PACKET | `01`, `02`, `03` | partial_local_verified | local checkout payload, webhook normalization, legacy trial event ignore, payment failure, cancellation, and renewal lifecycle tests pass; external sandbox mutation remains gated |
...
| `REQ-20260713-955` | Partial local verified | webhook/lifecycle mapping handles active subscription, invoice paid/failed, retry, cancellation, renewal, entitlement, and revenue states without secret exposure | `src/lib/billing/stripe-billing-lifecycle.js`, tests, smoke script | lifecycle tests pass | real sandbox webhook delivery/readback still pending after target guard |
