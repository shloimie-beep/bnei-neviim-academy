...
| REQ-20260705-605 | Publish the scheduler registration hardening so future re-registration works from a path with spaces. | RAW-20260705-010 | bna_platform / release_closeout | Codex | publish | P0 | B2 | Focused tests pass; branch is committed and pushed; PR is opened or exact blocker recorded. | Pushed - draft PR #100 open |
...
| Publish | Passed | Commit `7ba2108b` pushed to `codex/drive-dropoff-scheduler-repair-canonical-20260705`; draft PR #100 opened. |

## Next safest batch

1. Merge or close PR #100 after normal review/gate.
