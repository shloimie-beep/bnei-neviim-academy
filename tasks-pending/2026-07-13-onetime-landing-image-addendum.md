...
| REQ-20260713-929 | Remove stale landing promises about portals/platform/library/badges and retune the gain-card crops before signup traffic. | RAW-20260713-007 | Local verified; deploy pending | `public/one-time/index.html`; `tests/one-time-focused-landing.test.js`; `ops/ui-audits/2026-07-13-onetime-landing-image-addendum/after-copy-crop-metrics.json`; screenshots `after-copy-crop-gain-1440.png`, `after-copy-crop-gain-430.png`, `after-copy-crop-gain-390.png`, `after-copy-receive-1440.png`; PASS `node --test tests/one-time-focused-landing.test.js tests/service-provider-lead-bot.test.js tests/one-time-direct-signup-page.test.js`; PASS `npm run test:onetime:focused`; PASS `node scripts/smoke-onetime-landing-whatsapp-local.mjs`. |
