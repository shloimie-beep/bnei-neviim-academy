...
| Deploy/live-smoke required for app-visible work | yes - the enclosing owner-experience closure prompt authorizes deploying safe app-visible One Time fixes to the existing Railway service, and the operator said "keep going" in this session |
| Next requirement IDs to work | REQ-20260710-046 deployment/live smoke closeout |
...
| External/provider blockers | final hero image, public photo permissions/captions, verified address spelling/approval, verified social URLs, direct WhatsApp runtime number/readiness |
| Next exact packet | Deploy the current scoped landing commit to One Time Railway and run live smoke/readback proof. |
...
| REQ-20260710-043 | Integrate Robot Scheller as a non-obstructing floating utility using the real existing assistant/WhatsApp integration and no fake clickable WhatsApp state. | RAW-20260710-007:S271-S292; RAW-20260710-009 | rabbi_sheller_provider / one_time_mishnah_class | Codex | assistant_ui | P1 | B5 | REQ-20260710-037 | Floating control is about 52-56px, accessible, includes automated-assistant disclosure in expanded UI, does not cover form/carousel/nav/footer, and only exposes direct WhatsApp if runtime readiness is functional. Latest downloaded Robot Scheller image is used in the bubble. | public/js/bna-bot-widget.js, public/one-time/index.html, public/assets/one-time/robot/robot-scheller-whatsapp.png | app deploy pending | Done - local verified; runtime WhatsApp readiness remains externally blocked |
...
| DEC-20260710-011 | Robot Scheller generated image | Resolved on 2026-07-10 from the newest downloaded image: `ChatGPT Image Jul 10, 2026, 06_43_03 PM.png`. | Shloimie | Use the tightly cropped 512px repo asset in the circular assistant launcher bubble. | Use the full uncropped image, but it reads too small in the 54px launcher. | Exact Robot Scheller visual is no longer blocked; runtime WhatsApp readiness remains separately blocked. | Browser bubble proof refreshed at `ops/ui-audits/2026-07-10-onetime-public-landing-production-rebuild/focus-robot-scheller-launcher-1440.png`. | REQ-20260710-043 | Resolved - local image imported |
...
| DEC-20260710-015 | Deployment authorization | The landing prompt says not to deploy unless explicitly authorized by the enclosing task. The enclosing owner-experience closure prompt authorizes safe app-visible One Time deployment, and the operator said "keep going" in this session. | Shloimie | Deploy only the scoped, verified One Time landing fixes to the existing Railway `one-time-web` production service. | Stop at local proof only. | Without deploy/live smoke, production Done cannot be claimed. | Commit/push the scoped rebuild, deploy to One Time Railway, and run live smoke/readback. | REQ-20260710-046 | Resolved - enclosing goal authorizes deploy |

## Implementation map

| ID | Files/routes/components | Plan | Verification | Commit | Pushed commit | Deployment/live-smoke |
|---|---|---|---|---|---|---|
| REQ-20260710-037 | raw-input, tasks-pending, ops/prompt-packets, ops/ui-audits | Create intake, Product Quality packet, control tower, visual audit baseline. | PASS `npm run pqc:validate`; before screenshots and metrics captured. | not requested | not requested | no app deploy needed |
| REQ-20260710-038 | public/assets/one-time, public/one-time/index.html | Copy verified available assets into repo paths and centralize use. | PASS browser screenshots; PASS no Downloads refs in production code; asset report added. | not requested | not requested | blocked pending operator authorization |
| REQ-20260710-039 | public/one-time/index.html | Rebuild header/hero and CTA model. | PASS static tests; PASS Playwright after screenshots at 1440/1280/1024/768/430/390/375/360/320. | not requested | not requested | blocked pending operator authorization |
| REQ-20260710-040 | public/one-time/index.html, `/api/one-time/interest` | Modal/sheet quick capture using real endpoint path with intercepted no-send browser proof. | PASS `verify-after.mjs`: required parent/email, optional phone, no student field, one intercepted request. | not requested | not requested | blocked pending operator authorization |
| REQ-20260710-041 | public/one-time/index.html, `public/one-time-preview.html` | Continue after lead capture to existing onboarding with audience intent and no contact data in URL. | PASS `verify-after.mjs`: disabled until audience choice, `/one-time-preview` params are non-secret. | not requested | not requested | blocked pending operator authorization |
| REQ-20260710-042 | public/one-time/index.html | Section rebuild, marquee, carousel, footer. | PASS browser screenshots; footer links corrected to `/one-time/privacy.html` and `/one-time/terms.html`; asset report documents held-back files. | not requested | not requested | blocked pending operator authorization |
| REQ-20260710-043 | public/js/bna-bot-widget.js, public/one-time/index.html, public/assets/one-time/robot/robot-scheller-whatsapp.png | Floating Robot Scheller utility; direct WhatsApp only through guarded runtime redirect. | PASS helper isolation tests; PASS action registry watchdog; latest downloaded Robot Scheller image imported and cropped for bubble; WAPI/direct number readiness remains externally blocked. | not requested | not requested | blocked pending operator authorization |
| REQ-20260710-044 | public/one-time/index.html, public/one-time-preview.html | Responsive/a11y/performance polish. | PASS 9-viewport verifier; no overflow, one h1, no console/page errors, helper bottom-corner placement. | not requested | not requested | blocked pending operator authorization |
| REQ-20260710-045 | public/one-time/index.html | Remove forbidden old elements and copy. | PASS static grep/tests and browser verifier: no inline form, FAQ, old CTA labels, required phone, or student quick-capture field. | not requested | not requested | blocked pending operator authorization |
| REQ-20260710-046 | registries, evidence, ledger, changelog | Record proof and blockers. | PASS `npm test` 1735/1735, PQC, action watchdog, protocol drift, visual verifier; deploy/live proof pending. | pending | pending | pending |
...
| REQ-20260710-038 | Done - local verified | `public/assets/one-time/*`; `public/assets/one-time/one-time-asset-manifest.json`; `ops/ui-audits/2026-07-10-onetime-public-landing-production-rebuild/asset-report.md`; after screenshots. | public/assets/one-time, public/one-time/index.html | Focused landing tests PASS; browser verifier PASS. | Final hero image and public-photo permissions/captions remain operator/provider decisions. |
...
| REQ-20260710-043 | Done - local verified | helper isolation tests; action watchdog report `ops/watchdog-audits/2026-07-10T15-48-watchdog-action-audit.md`; `public/assets/one-time/robot/robot-scheller-whatsapp.png`; `ops/ui-audits/2026-07-10-onetime-public-landing-production-rebuild/focus-robot-scheller-launcher-1440.png`. | public/js/bna-bot-widget.js, public/one-time/index.html, public/assets/one-time/robot/robot-scheller-whatsapp.png, ops/action-registry.json | `npm run watchdog:actions` PASS; helper tests PASS; latest Robot Scheller image imported and tightly cropped for the 54px bubble. | Direct WhatsApp runtime number/readiness remains externally blocked. |
...
| REQ-20260710-046 | In progress - local verified | `ops/ui-audits/2026-07-10-onetime-public-landing-production-rebuild/npm-test-latest.log`; screenshots; action/protocol reports; PQC report; asset report. | registries, tests, evidence | PASS `npm test` 1735/1735; PASS `verify-after.mjs`; PASS `npm run pqc:validate`; PASS `npm run watchdog:actions`; PASS `npm run watchdog:protocol-drift`; PASS syntax checks. | Commit/push/deploy/live smoke pending. |
