...
- [x] `RAW-20260705-008` / `REQ-20260705-401` through `REQ-20260705-406`:
  ...
  PR #97 merged at `e405bfe484db6515ccc52d4d9913938ee9e0d633`; production
  source readback found the new One Time sidebar keys and black/yellow CSS
  tokens; `npm run app:smoke:one-time-shared-review` and `npm run app:smoke`
  passed. Railway deployment-ID readback is blocked by the current token/target
...
- [x] `RAW-20260710-002` / `REQ-20260710-013` through
  ...
  reconciliation are recorded. The immediate free-class transactional
  follow-up ledger is implemented as idempotent blocked email/WhatsApp timeline
  attempts with recipient hashes and no-send guardrails. Rabbi backend
  launch-readiness copy/state cleanup is committed, pushed, deployed, and
  ...
  detail view; deployment `d7abb60c-def4-4105-be8a-f160225b442d` shipped the
  blocked transactional follow-up ledger; final deployment
  `aeb8710f-03ef-4a07-995a-9df6cedac140` shipped the Rabbi backend cleanup.
  The latest live workbench smoke read 12 scoped CRM cards and a no-send
  selected timeline; the latest CRM E2E smoke created CRM lead `10`, verified
  blocked transactional email/WhatsApp timeline attempts, and archived the lead.
  Final Rabbi backend live readback confirmed the provider access-boundary copy
  is clean and the old raw scope/super-admin diagnostic sentence is absent.
  `REQ-20260710-021` is terminal as `Needs operator decision`: current One Time
  shows 0 email-import-tagged records, and `DEC-20260710-004` requires canonical
  historical source/suppression policy approval before any import/write. Real
  external transactional delivery remains blocked by runtime/readiness and
  exact send approval. `REQ-20260710-024` is terminal as Already satisfied
  because no unblocked outgoing ChatGPT code-package lane remains; `REQ-20260710-025`
  is Done with pushed commits, Railway deploys, live smokes, screenshot proof,
  and terminal statuses recorded.
...
- [ ] One Time: finish live Rabbi bot runtime by collecting the confirmed Rabbi chat ID, setting `TELEGRAM_CHAT_ID_RABBI_ELIE_SCHELLER`, choosing/starting the hosted bridge worker for `npm run telegram:rabbi`, and smoking `/status`, task/comment, and ticket creation; scoped One Time username/password are now installed locally and on Railway. 2026-07-09 update: `t.me/onetimeaios_bot` token was provided by Shloimie and handled as a redacted credential intake; readiness shows the Rabbi token is configured, and `npm run telegram:rabbi:chat-id` resolved the bot but found 0 pending candidates, so the remaining blocker is the intended account/group sending `/start` to the bot, confirming the allowed chat ID, and setting it.
...
- [ ] `RAW-20260713-010 / REQ-20260713-931 through REQ-20260713-941`: One Time final integration launch goal-mode packet. Register: `tasks-pending/2026-07-13-onetime-final-integration-launch.md`. Gate 1 is recorded at `ops/system-audits/2026-07-13-onetime-final-integration-launch/report.md`; `REQ-20260713-933` current-state P0 reproduction/PQC audit is done at `ops/ui-audits/2026-07-13-onetime-final-launch-current-state/report.md`; `REQ-20260713-934` is Done with member, auth/admin, and student-login evidence; `REQ-20260713-935` is Done at One Time SHA `11e5ba0d4da6ae8897294be81a567bb519943ab2` with responsive evidence `ops/ui-audits/2026-07-13-onetime-landing-signup-responsive-live/REPORT.md`, signup matrix `ops/live-smokes/2026-07-13T20-50-12-287Z-one-time-signup-form-matrix-live.md`, and no-write dry-run `ops/live-smokes/2026-07-13T20-50-12-079Z-one-time-interest-dry-run-live-smoke.md`. `REQ-20260713-937` is Done at One Time SHA `050170d3ce5e9d0ea8e0db5ca0fa96b369bff0b5` with PR #132 no-wholesale-merge audit `ops/audits/2026-07-14-onetime-billing-pr132-reconciliation-audit.md`, sandbox verifier `ops/verifier-runs/2026-07-14-onetime-billing-sandbox-e2e/latest.md`, parent no-trial campaign smoke `ops/live-smokes/2026-07-13T21-42-33-620Z-rabbi-onetime-landing-smoke.md`, and Operations billing/referral smoke `ops/live-smokes/2026-07-13T21-44-55-248Z-one-time-trial-referral-live-smoke.md`. `REQ-20260713-938` is Done with media/classroom/Zoom truth audit `ops/audits/2026-07-14-onetime-media-classroom-zoom-truth.md` and no-write live smokes for transcript privacy, Zoom readiness, metadata readback, and classroom/member-library at SHA `050170d3ce5e9d0ea8e0db5ca0fa96b369bff0b5`. `REQ-20260713-939`, `REQ-20260713-940`, and `REQ-20260713-941` are Blocked: release target guard passed and no-write public launch smoke evidence is refreshed at `ops/production-readiness/2026-07-12-no-write-live-smoke-readback.md`, but secure owner/canary aliases, owner-test email/WhatsApp aliases, and campaign seed approvals remain missing. Public WhatsApp approval is granted after canary/gates, Stripe sandbox work is authorized under the no-trial/no-surprise $67/month policy, and PR #132 must not merge wholesale. Next action is external: configure secure owner/canary aliases and campaign seed approvals, then rerun readiness/release gates.
