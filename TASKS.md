...
- [ ] `RAW-20260713-010 / REQ-20260713-931 through REQ-20260713-941`: One Time final integration launch goal-mode packet. Register: `tasks-pending/2026-07-13-onetime-final-integration-launch.md`. Gate 1 is recorded at `ops/system-audits/2026-07-13-onetime-final-integration-launch/report.md`; `REQ-20260713-933` current-state P0 reproduction/PQC audit is done at `ops/ui-audits/2026-07-13-onetime-final-launch-current-state/report.md`. `REQ-20260713-934` is Done: `PKT-20260713-934A` member portal first-render repair is deployed/live-smoked at One Time SHA `20307e2638988b6fe5d10b8a649d87ed8a8522cb`, and `PKT-20260713-934B`/`934C` auth/admin context plus provider/student request-console cleanup are deployed/live-smoked at One Time SHA `e973ce50b86e7566034faf8a604133a4870e4d7b` with evidence at `ops/ui-audits/2026-07-13-onetime-auth-admin-context-live/report.md`. Next unblocked requirement is `REQ-20260713-935`; public WhatsApp approval is granted after canary/gates, Stripe sandbox work is authorized under the no-trial/no-surprise $67/month policy, and PR #132 must not merge wholesale.
