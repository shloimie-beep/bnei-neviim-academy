...
async function main() {
  ...
  const routes = [
    ...
    },
    {
      ...
      expectedTitle: /One Time (?:Provider|Rabbi Workspace) Review/i,
    ...
    },
    {
      ...
      expectedTitle: /One Time Parent Review|BNA Parent Portal/i,
    ...
    },
    {
      ...
      expectedTitle: /One Time Student Review|BNA Student Goal Board/i,
