...
async function main() {
  ...
  const routes = [
    ...
    },
    {
      ...
      requiredText: ['One Time provider review', 'Rabbi/admin TEST review workspace', 'Branded TEST review'],
    ...
    },
    {
      ...
      requiredText: ['Parent Review Portal', 'One Time parent review portal', 'TEST Student One Time'],
      requiredSelectors: ['img[src*="onetimelogo"]'],
      forbidTitle: /BNA|Bnei Neviim/i,
      forbidText: ['Bnei Neviim Academy', 'Dratler Family'],
    },
    {
      ...
      requiredText: ['ONE TIME STUDENT REVIEW', 'One Time student review mode', 'General study assistants, accountability-goal tooling, and unrelated student records are not included'],
      requiredSelectors: ['img[src*="onetimelogo"]'],
      forbidTitle: /BNA|Bnei Neviim/i,
