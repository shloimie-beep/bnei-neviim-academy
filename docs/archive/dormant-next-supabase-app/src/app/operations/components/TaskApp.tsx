...
/**
 * LEGACY/DORMANT TASK UI.
 *
 * This React surface reads and writes browser localStorage through
 * `src/lib/tasks/store.ts`. It is not the live BNA Operations dashboard.
 * For active Operations task/dashboard changes, edit `public/operations.html`
 * and the Express/server API paths that feed it.
 */
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-xs font-semibold text-red-700">
                Legacy dormant local task prototype. Live dashboard source: public/operations.html.
              </p>
            </div>
            <button
