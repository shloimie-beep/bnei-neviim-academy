export type TaskCategory = 'Accounting' | 'Marketing' | 'Communications' | 'Torah Research';
...
export const CATEGORIES: TaskCategory[] = ['Accounting', 'Marketing', 'Communications', 'Torah Research'];
