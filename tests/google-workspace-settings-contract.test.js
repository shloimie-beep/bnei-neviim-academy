...
test('Operations auth allows the Integrations module for admin and provider workspaces', () => {
  ...
  assert.match(server, /providerAllowedViews = \['dashboard', 'watchdog', 'pipelines', 'tasks', 'agents', 'contacts', 'intake', 'community', 'studio', 'content', 'live_classes', 'calendar', 'service_providers', 'communications', 'internal_dialogue', 'automations', 'api_usage', 'integrations', 'settings'\]/);
