...
test('public OneTime draft page is noindex, interest-only, and has no checkout call', () => {
  ...
  assert.match(oneTimeHtml, /id="signupParentName"/);
  assert.match(oneTimeHtml, /id="signupEmail"/);
  assert.match(oneTimeHtml, /id="signupStudentName"/);
  assert.match(oneTimeHtml, /id="signupPhone"/);
  ...
  assert.doesNotMatch(oneTimeHtml, /parent access next steps/i);
  assert.doesNotMatch(oneTimeHtml, /Parent portal setup instructions/i);
